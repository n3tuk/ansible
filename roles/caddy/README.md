...
| `caddy_update`                    | `false`                                                                  | (**optional**) Whether to update Caddy to the latest version, or add new features, if already installed (in order to keep versions consistent, this is disabled by default). |
